...
router.push(`/movie/${id}`);
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="mx-auto bg-gray-900 rounded-3xl shadow-xl border border-gray-800">
        <div className="grid rounded-3xl max-w-[360px] shadow-sm bg-gray-800 flex-col group">
          {/* Poster Image */}
          <Image
            src={poster}
            width="360"
          ...
          <div className="p-5 z-10">
            {/* Movie Title */}
            <p className="h-10 text-gray-100 font-bold text-lg line-clamp-2">{title}</p>
            <p className="text-blue-300 pt-2 font-semibold ">({releaseYear})</p>
            {/* Movie Description */}
            <div className="h-20">
              <span className="line-clamp-3 py-2 h-20 text-sm font-light leading-relaxed text-gray-300">
                {description}
              </span>
            </div>
            {/* Movie Rating */}
            <div className="grid-cols-2 flex justify-between">
              <div className="font-black flex flex-col">
                ...
                <span className="text-3xl flex gap-x-1 items-center group-hover:text-yellow-300 text-yellow-400">
